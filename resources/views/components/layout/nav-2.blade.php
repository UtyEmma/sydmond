    ...
    <div class="aside-dropdown__inner"><span class="aside-dropdown__close">
        ...
        <div class="aside-dropdown__item">
            ...
            <ul class="aside-socials">
                <li class="aside-socials__item"><a class="aside-socials__link" href="{{env('INSTAGRAM')}}"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                <li class="aside-socials__item"><a class="aside-socials__link aside-socials__link--active" href="{{env('TWITTER')}}"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                <li class="aside-socials__item"><a class="aside-socials__link" href="{{env('FACEBOOK')}}"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            </ul>
        </div>
