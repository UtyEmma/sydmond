    ...
    <main class="main">
        ...
        <section class="section info no-padding-top">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="info__img"><img class="img--layout" src="img/info_img-layout.png" alt="img"/><img src="img/info_img.png" alt="img"/></div>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="row margin-bottom">
                                <div class="col-12">
                                    <div class="heading heading--primary heading--center">
                                        <h2 class="heading__title no-margin-bottom"><span>Founding</span> <span>Partner</span></h2>
                                    </div>
                                </div>
                            </div>
